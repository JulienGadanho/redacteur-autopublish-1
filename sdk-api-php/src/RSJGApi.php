...
/**
 * Class RSJGApi Vous devez étendre cette classe et implémenter les 4 dernières méthodes à votre façon
 */
class RSJGApi extends RSJGApiClient implements RSJGServices
{
    protected $mode;
